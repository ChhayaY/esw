...
object Libs {
  ...
  private val MSocketVersion  = "d438545"
  ...
  val `akka-http-metrics-prometheus` = "fr.davit" %% "akka-http-metrics-prometheus" % "0.6.0"
}

object Csw {
  private val Org     = "com.github.tmtsoftware.csw"
  private val Version = "426c294" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
